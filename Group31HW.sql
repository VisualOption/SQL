...
select students.email from students;

--6. Вывести имя и email пользователей
select students.name, students.email from students;

--7. Вывести id, имя, email и дату создания пользователей
select students.id, students.name, students.email, created_on from students;

--8. Вывести пользователей где password 12333
select * from students
where password = '12333'; (отличается от MySQL где без кавычек)
...
select students.id, students.name, created_on from students
